...
const _byd = ({"ENV":"dev","AREA":"dev","SCRIPTS":["plugins.js","utils.js","initial.js","Navigation.js","StickyElement.js","CatalogModal.js","MagicText.js","KillWidows.js","CustomKerning.js","app.js"],"PAGES":{},"LINKS":{"SERVE":"http://localhost:9000/","DEV":"http://localhost:8000/","STAGE":"https://staging.benyan.dev/","PROD":"https://benyan.dev/"}});
...
exports.onRenderBody = ({
  ...
  try {
    ...
    setPreBodyComponents([/*#__PURE__*/React.createElement("base", {
      href: baseUrl,
      key: 'idk-why-this-needs-a-key'
    })]); //
    // POST BODY
    ...
    if (_byd.ENV === 'prod') {
      scripts = /*#__PURE__*/React.createElement("script", {
        type: "text/javascript",
        src: "scripts/main.js"
      });
    } else {
      scripts = _byd.SCRIPTS.map((script, i) => /*#__PURE__*/React.createElement("script", {
        type: "text/javascript",
        src: `scripts/${script}`,
        key: `_script_${i}`
      }));
