  ...
  return (
    <html {...props.htmlAttributes}>
      <head>
        ...
        <link href="https://fonts.googleapis.com/css2?family=Playfair+Display:ital,wght@0,400;0,700;0,900;1,400;1,600;1,900&display=swap" rel="stylesheet" />
        {/* <link
          rel="icon"
          type="image/png"
          sizes="16x16"
